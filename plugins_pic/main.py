...
async def help_session(client, message):
 try:
    ...
    if update_existing_db:
        ...
        await client.send_cached_media(chat_id=user_id, file_id="BAACAgUAAxkDAAIYRWZup8Zdj7OV12ZJNY6AF5xOqeIqAALKEAAC3GF4VwZicI9ro9bHHgQ", caption="Hᴏᴡ ᴛᴏ ᴜᴘᴅᴀᴛᴇ ᴛʜɪs ʙᴏᴛ")
 except Exception as e:
    await message.reply_text(e)
