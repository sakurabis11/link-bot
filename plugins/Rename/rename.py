...
async def rename_start(client, message):
    # Check if it's the "/rename" command
    if message.text == "/rename":
        await message.reply_text("Please reply to a message containing a file to rename it!")
        return
    ...
    if file.file_size > 2000 * 1024 * 1024:
        await message.reply_text("Sorry Bro This Bot Doesn't Support Uploading Files Bigger Than 2GB")
        return
