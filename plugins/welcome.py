...
async def set_welcome(client, message: Message):
  try:
    ...
    await db.set_welcome(welcome_message, message.chat.id)  # Added the missing argument
...
async def remove_welcome(client, message: Message):
  try:
        ...
        welcome_message = await db.get_welcome(message.chat.id)  # Removed extra argument
