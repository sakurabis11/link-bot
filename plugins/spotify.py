...
spotify = Spotify(auth_manager=SpotifyOAuth(client_id=os.environ['d3a0f15a75014999945b5628dca40d0a'],
                                             client_secret=os.environ['e39d1705e35c47e6a0baf50ff3bb587f'],
