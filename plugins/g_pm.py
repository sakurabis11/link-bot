...
@Client.on_message(filters.command('filter') & filters.private & filters.user(ADMINS))
...
@Client.on_message(filters.command('view') & filters.private & filters.user(ADMINS))
...
@Client.on_message(filters.command('delall') & filters.private & filters.user(ADMINS))
