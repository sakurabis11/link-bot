...
ᴄʀᴇᴅɪᴛs @masterolic"""
    ...
    SPOTIFY_TXT = """sᴇɴᴅ sᴘᴏᴛɪғʏ ᴛʀᴀᴄᴋ ᴜʀʟ\ɴ
ғᴏʀ ɢᴇᴛᴛɪɴɢ sᴏɴɢ
...
ᴊᴜsᴛ sᴇɴᴅ ᴀ ᴠɪᴅᴇᴏ ᴛᴏ ᴛʜᴇ ʙᴏᴛ ᴀɴᴅ sᴇɴᴅ <code>/ᴄᴏɴᴠᴇʀᴛ</code> ᴛᴏ ᴛʜᴇ ᴠɪᴅᴇᴏ.
sᴜᴘᴘᴏᴛ ᴏɴʟʏ ᴠɪᴅᴇᴏ

ᴄʀᴇᴅɪᴛs @MrTG_Coder"""

    CLONE_TXT ="""ʜᴇʏ {},
ɢᴇᴛ ʏᴏᴜʀ ʙᴏᴛ ᴛᴏᴋᴇɴ ғʀᴏᴍ @BotFather .
ᴍᴀᴋᴇ ʏᴏᴜʀ ᴏᴡɴ ᴄʟᴏɴᴇ ʙᴏᴛ ᴡɪᴛʜ ᴄᴏᴍᴍᴀɴᴅ /add (ʙᴏᴛ_ᴛᴏᴋᴇɴ)
/my_bots ᴛᴏ sᴇᴇ ʜᴏᴡ ᴍᴜᴄʜ ʙᴏᴛ ᴛʜᴀᴛ ʏᴏᴜ ᴄʟᴏɴᴇᴅ.
/delete (bot_username) ᴛᴏ ᴅᴇʟᴇᴛᴇ ᴛʜᴇ ᴄʟᴏɴᴇ ғᴇᴀᴛᴜʀᴇ ᴀɴᴅ ɪᴛ ᴡɪʟʟ ᴛᴀᴋᴇ sᴏᴍᴇ ᴛɪᴍᴇ ᴛᴏ ᴅᴇʟᴇᴛᴇ ᴛʜᴀᴛ ʙᴏᴛ.
